...
import markdownItCitation from './markdown-it-citation'
...
import { bindPreviewInteractions, closePreviewInteractions, scrollToHashTarget } from './preview'
    ...
    return (
      <React.Fragment>
        <Head>
          ...
          <script type="text/javascript" src="/_static/export.js"></script>
        </Head>
        <main
