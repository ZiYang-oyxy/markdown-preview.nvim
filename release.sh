...
GH_REPO="$GH_API/repos/ZiYang-oyxy/markdown-preview"
...
do
  GH_ASSET="https://uploads.github.com/repos/ZiYang-oyxy/markdown-preview/releases/$id/assets?name=$filename"
